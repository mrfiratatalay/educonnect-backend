        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidUntilUtc = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailVerifiedAtUtc = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    EmailVerificationCodeHash = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    EmailVerificationExpiresAtUtc = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    EmailVerificationSentAtUtc = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    EmailVerificationAttemptCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserLowerId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserHigherId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    FeatureArea = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDescription = table.Column<string>(type: "character varying(220)", maxLength: 220, nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    RulesJson = table.Column<string>(type: "character varying(4000)", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "VisualSearchHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    QueryImageUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisualSearchHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisualSearchHistories_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IntentDetected = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    Confidence = table.Column<double>(type: "double precision", nullable: true),
                    ModelUsed = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    KbScore = table.Column<double>(type: "double precision", nullable: true),
                    KbHit = table.Column<bool>(type: "boolean", nullable: true),
                    IsFallback = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    JoinedAtUtc = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    Role = table.Column<int>(type: "integer", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisualSearchResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisualSearchResults_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VisualSearchResults_VisualSearchHistories_SearchHistoryId",
                        column: x => x.SearchHistoryId,
                        principalTable: "VisualSearchHistories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisualSearchHistories_UserId",
                table: "VisualSearchHistories",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_VisualSearchResults_ProductId",
                table: "VisualSearchResults",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_VisualSearchResults_SearchHistoryId",
                table: "VisualSearchResults",
